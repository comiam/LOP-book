...
Анализ формальных понятий (АФП) является прикладной ветвью алгебраической теории решеток, в рамках которой предложен математический формализм, описывающий на языке алгебры понятие и иерархии понятий. Основные идеи АФП были сформулированы Рудольфом Вилле и Бернандом Гантером.
...
\node[scale=1.1] at (2,-1.6) {Я};
\node[scale=1.1] at (2,-.6) {В};
\node[scale=1.1] at (2,.4) {П};
